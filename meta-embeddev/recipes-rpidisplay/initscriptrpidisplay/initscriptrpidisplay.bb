...
INITSCRIPT_NAME = "initscriptrpidisplayscript"
...
FILESEXTRAPATHS_prepend := "${THISDIR}/initscriptrpidisplay:"
SRC_URI = "file://initscriptrpidisplayscript"
...
do_install() {
    ...
    install -m 0755 initscriptrpidisplayscript ${D}/etc/init.d
}
